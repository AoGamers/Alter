...
on_button(interfaceId = BANK_INTERFACE_ID, component = 56) {
    player.message("player.getVarbit(SELECTED_TAB_VARBIT).")
...
on_button(interfaceId = BANK_INTERFACE_ID, component = 47) {
    ...
    player.playSound(Sounds.FIREBREATH)
...
on_button(interfaceId = BANK_INTERFACE_ID, component = 68) {
    // RELEASE ALL PLACEHOLDERS

}
on_button(interfaceId = BANK_INTERFACE_ID, component = 50) {
    player.setVarbit(4170, player.getInteractingSlot())
}