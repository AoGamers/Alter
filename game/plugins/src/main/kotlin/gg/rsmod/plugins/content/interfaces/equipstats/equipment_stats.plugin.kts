package gg.rsmod.plugins.content.interfaces.equipstats

import gg.rsmod.plugins.api.EquipmentType.Companion.EQUIPMENT_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.equipstats.EquipmentStats.EQUIPMENTSTATS_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.equipstats.EquipmentStats.EQUIPMENTSTATS_TAB_INTERFACE_ID
import gg.rsmod.plugins.content.interfaces.equipstats.EquipmentStats.sendBonuses
