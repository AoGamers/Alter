...
object EquipmentStats {
    ...
    private val MAGE_ELITE_VOID = intArrayOf(gg.rsmod.plugins.api.cfg.Items.VOID_MAGE_HELM, gg.rsmod.plugins.api.cfg.Items.ELITE_VOID_TOP, gg.rsmod.plugins.api.cfg.Items.ELITE_VOID_ROBE, gg.rsmod.plugins.api.cfg.Items.VOID_KNIGHT_GLOVES)
